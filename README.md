...
Dashboard interaktif berbasis **Streamlit** untuk menganalisis data penyewaan sepeda (*Bike Sharing*).  
...
3. **Korelasi Faktor Lingkungan**  
   *Heatmap* yang menunjukkan hubungan antara suhu, kelembapan, kecepatan angin, dan jumlah penyewaan.
